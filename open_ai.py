...
async def generate_story(request: StoryRequest):
          ...
          messages=[
    {
        ...
        "content": (
            ...
            "- `causeOfDeath`: 만약 현재 상황에서 사망한다면 어떤 사유로 사망하게 되는지 20글자 내외로 설명. 문장의 끝은 '사망...'으로 끝나야하고 앞 단어들과 문맥상 자연스럽게 연결이 되어야해. 현재 상황과 연관이 있고 논리적으로 납득이 되는 사망사유여야한다. 사망 상황이 아니더라도, 현재 상황과 관련된 사망 원인을 반드시 포함해야한다. 사망사유는 잔인하지 않아야해.ex) 나무 밑에 있는 독버섯을 먹고 사망..., 맹수에게 공격당해 사망..., 내리막길에서 미끄러져 사망..., 독사에게 물려 사망..."
